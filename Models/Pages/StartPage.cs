...
using InterlogicTask.Models.Blocks;
...
namespace InterlogicTask.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(UspCalculationPage) }, // Pages we can create under the start page...
